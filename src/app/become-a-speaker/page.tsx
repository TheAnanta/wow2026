...
const inputBaseCls =
  "w-full rounded-[8px] border border-white/20 bg-[#141517] px-4 py-3 text-sm text-white placeholder:text-[#9aa0a6] shadow-sm transition hover:border-white/35 focus:border-[#4285f4] focus:outline-none focus:ring-2 focus:ring-[#4285f4]/30";

const labelCls =
  "mb-2 block text-sm font-medium text-[#e8eaed]";

const sectionCls = "border-t border-white/12 pt-10";
const selectOptionCls = "bg-[#141517] text-white";
...
function SpeakerApplicationForm() {
  ...
  return (
    <form
      ...
      className="rounded-[8px] border border-white/14 bg-[#0f1012] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.36)] ring-1 ring-white/5 md:p-10 lg:p-12 space-y-12"
    >
      {submitted && (
        <div className="rounded-[8px] border border-[#34a853]/50 bg-[#34a853]/12 px-5 py-4 text-sm font-medium text-[#d8f7df]">
      ...
      <section>
        <div className="mb-6">
          <p className="mb-2 text-xs font-semibold uppercase tracking-[0.14em] text-[#8ab4f8]">Step 01</p>
          <h2 className="text-xl font-semibold text-white">Speaker Details</h2>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div>
            ...
            <input
              className={`${inputBaseCls} file:mr-4 file:rounded-full file:border-0 file:bg-[#4285f4] file:px-4 file:py-2 file:text-sm file:font-semibold file:text-white hover:file:bg-[#669df6]`}
              name="speakerPhoto"
              type="file"
              accept="image/*"
              required
      ...
      <section className={sectionCls}>
        <div className="mb-6">
          <p className="mb-2 text-xs font-semibold uppercase tracking-[0.14em] text-[#fdd663]">Step 02</p>
          <h2 className="text-xl font-semibold text-white">Talk Proposal</h2>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div>
            ...
            <select className={inputBaseCls} name="sessionFormat" required>
      ...
      <section className={sectionCls}>
        <label className="flex items-start gap-3 text-sm font-medium leading-6 text-[#e8eaed]">
          <input
            className="mt-1 h-5 w-5 rounded border border-white/30 bg-[#141517] accent-[#4285f4]"
            type="checkbox"
            name="termsAccepted"
            required
          />
      ...
      <div className="flex justify-end">
        <button
          type="submit"
          className="rounded-full bg-[#4285f4] px-8 py-3 text-sm font-semibold text-white transition hover:bg-[#669df6] focus:outline-none focus:ring-2 focus:ring-[#8ab4f8] focus:ring-offset-2 focus:ring-offset-[#0f1012]"
        >
          Submit Proposal
        </button>
      </div>
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="mx-auto max-w-5xl px-4 py-10 md:px-8 md:py-14">
        <div className="mb-10 max-w-3xl">
          ...
          <h1 className="mb-3 text-4xl font-semibold tracking-normal text-white md:text-5xl">
            Become a Speaker
          </h1>
          <p className="text-base leading-7 text-[#bdc1c6] md:text-lg">
