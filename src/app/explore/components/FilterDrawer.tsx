                  ...
                  <div key={option.id} className="flex items-center">
                    <div className="relative flex items-center">
                      <input
                        ...
                        className="peer appearance-none border-2 border-grey-900 dark:border-white h-5 w-5 rounded focus:outline-none focus:ring-2 focus:ring-blue transition-all cursor-pointer checked:bg-blue checked:border-blue dark:checked:bg-blue-dark dark:checked:border-blue-dark"
                      />
                      <svg
                        className="absolute w-3 h-3 text-white pointer-events-none hidden peer-checked:block left-1 top-1"
