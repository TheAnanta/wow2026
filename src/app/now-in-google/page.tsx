                            ...
                            <div className="grid md:grid-cols-2 md:gap-8 lg:grid-cols-3 lg:justify-items-center">
                                ...
                                <div className="basis-full">
                                    ...
                                    <div className="text-grey-900 mt-6 dark:text-white">
                                        ...
                                        <p className="font-normal sm:s-p2 md:l-p1">Manage your WOW wallet, recharge for the WOW+ Add-on, and track your rank on the live leaderboard.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div className="border-2 rounded-2xl border-grey-900 dark:border-grey-bg overflow-hidden">
                                        ...
                                        <dl className="px-[30px] pb-[50px] pt-5 md:px-12 md:pb-10 md:pt-[42px]">
                                            <div className="pt-[14px] pr-12 border-b-2 mb-[18px] pb-[14px] border-grey-900 dark:border-grey-bg text-grey-900 dark:text-white">
                                                ...
                                                <dd className="mt-4 mb-[18px] md:mt-5 faq-entry">
                                                    <p>The Google WOW Wallet can be refueled and used for everything—from the WOW+ Add-on to the food court. No need to carry cash or cards during the event.</p>
                                                </dd>
                                            </div>
                                            <div className="pt-[14px] pr-12 text-grey-900 dark:text-white">
                                                <dt className="font-medium sm:s-h5 md:l-h5">The WOW+ Add-on Hub</dt>
                                                <dd className="mt-4 md:mt-5 faq-entry">
                                                    <p>The app is the official place to manage your WOW+ Add-on features. Be notified of workshops, book your 1-1 mentor sessions, and track your leaderboard status in real-time.</p>
                                                </dd>
                                            </div>
                                        </dl>
                                    </div>
