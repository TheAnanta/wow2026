...
export default function EventMetricsSection() {
    ...
    return (<div className="flex flex-col align-center items-stretch justify-center gap-y-4  md:gap-x-6 md:flex-row mt-6">
        ...
        <div className="md:w-[38%] md:max-w-[420px] shrink-0">
            <div className="relative h-full bg-grey-bg dark:bg-grey border md:border-2 border-grey rounded-[16px] pb-[120px] overflow-hidden dark:border-white">
                <div className="absolute bottom-0 right-0 md:max-w-[435px] rounded-br-[16px]">
                    <img src="https://io.google/2024/puzzle/media/images/landingpage.png" className="inline-block md:hidden dark:hidden -mr-[2px]" role="img" aria-hidden="true" width="283" height="172" alt="" loading="lazy" />
                    <img src="https://io.google/2024/puzzle/media/images/landingpage.png" className="hidden dark:inline-block dark:md:hidden -mr-[2px]" role="img" aria-hidden="true" width="283" height="172" alt="" loading="lazy" />
                    <img src="https://io.google/2024/puzzle/media/images/landingpage.png" className="hidden md:inline-block object-cover dark:hidden" role="img" aria-hidden="true" width="274" height="197" alt="" loading="lazy" />
                    <img src="https://io.google/2024/puzzle/media/images/landingpage.png" className="hidden dark:md:inline-block object-cover lg:object-contain object-left lg:object-right -mr-[2px] max-w-[272px]" role="img" aria-hidden="true" width="437" height="270" alt="" loading="lazy" />
                </div>
        ...
        <div className='w-full grid grid-cols-1 gap-y-9 mb-5 md:mb-[unset] md:gap-y-4 shrink-0 md:max-w-[200px]'>
        ...
        <div className='w-full grid grid-cols-1 gap-y-9 mb-5 md:mb-[unset] md:gap-y-4 shrink-0 md:max-w-[282px]'>
            <div className="relative h-[90px] md:h-[184px]">
                {/* Front card */}
                <div className="absolute bg-grey-bg dark:bg-grey w-full h-full rounded-xl border-[1.5px] md:border-2 border-solid border-grey dark:border-grey-bg z-10 overflow-hidden">
                    <div className="flex flex-col items-center justify-center gap-y-1 h-full">
        ...
        <div className='w-full flex flex-col gap-4 shrink min-w-0 min-h-0'>
            ...
            <a href="https://io.google/2024/explore/?q=codelab,learning-pathway" data-analytics-event="content_card_select" data-analytics-event-data="{&quot;cardName&quot;: &quot;codelab&quot;}"
                className="relative shrink-0 group mb-0 inline-block p-6 bg-grey-bg dark:bg-grey dark:hover:bg-grey-bg hover:bg-grey w-full border-[1px] md:border-2 border-grey rounded-[16px] overflow-hidden dark:border-white hover:border-white dark:hover:border-grey hover:ring-[1px] hover:md:ring-2 hover:ring-offset-4 hover:ring-grey dark:hover:ring-0 dark:hover:ring-offset-0 dark:hover:outline dark:hover:outline-white dark:hover:outline-2 dark:hover:outline-offset-8">
                ...
                <img src="https://io.google/2024/app/images/io24-learning-cta.webp" className="ml-auto max-w-[170px] absolute right-4 bottom-4 dark:hidden group-hover:hidden! dark:group-hover:inline-block! " role="img" aria-hidden="true" />
                <img src="https://io.google/2024/app/images/io24-learning-cta-dark.webp" className="ml-auto max-w-[170px] absolute right-4 bottom-4 hidden dark:inline-block group-hover:inline-block dark:group-hover:hidden! " role="img" aria-hidden="true" />
            </a>
        </div>
