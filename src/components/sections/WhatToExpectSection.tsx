        ...
        <div className="grid md:grid-cols-3 gap-4 md:justify-between md:gap-[32px] md:h-[240px]">
            ...
            <a href="https://io.google/2024/explore/?q=codelab,learning-pathway" data-analytics-event="content_card_select" data-analytics-event-data="{&quot;cardName&quot;: &quot;codelab&quot;}"
                ...
                <div className="mt-6">
                    ...
                    <p className="font-normal sm:s-p2 text-black dark:text-white group-hover:text-white dark:group-hover:text-black">Start coding today with self-paced exercises.</p>
                </div>
            </a>

            <a href="https://io.google/2024/explore/?q=workshop" data-analytics-event="content_card_select" data-analytics-event-data="{&quot;cardName&quot;: &quot;workshop&quot;}" className="group mb-0 inline-block p-6 bg-grey-bg dark:bg-grey dark:hover:bg-grey-bg hover:bg-grey w-full lg:min-w-[400px] border-[1px] md:border-2 border-grey rounded-[16px] overflow-hidden dark:border-white hover:border-white dark:hover:border-grey hover:ring-[1px] hover:md:ring-2 hover:ring-offset-4 hover:ring-grey dark:hover:ring-0 dark:hover:ring-offset-0 dark:hover:outline dark:hover:outline-white dark:hover:outline-2 dark:hover:outline-offset-8">
                ...
                <div className="mt-6">
                    ...
                    <p className="font-normal sm:s-p2 text-black dark:text-white group-hover:text-white dark:group-hover:text-black">Grow your skills through guided codelabs.</p>
                </div>
            </a>

            <a href="https://io.google/2024/explore/?q=demo" data-analytics-event="content_card_select" data-analytics-event-data="{&quot;cardName&quot;: &quot;demo&quot;}" className="group mb-0 inline-block p-6 bg-grey-bg dark:bg-grey dark:hover:bg-grey-bg hover:bg-grey w-full lg:min-w-[400px] border-[1px] md:border-2 border-grey rounded-[16px] overflow-hidden dark:border-white hover:border-white dark:hover:border-grey hover:ring-[1px] hover:md:ring-2 hover:ring-offset-4 hover:ring-grey dark:hover:ring-0 dark:hover:ring-offset-0 dark:hover:outline dark:hover:outline-white dark:hover:outline-2 dark:hover:outline-offset-8">
                ...
                <div className="mt-6">
                    ...
                    <p className="font-normal sm:s-p2 text-black dark:text-white group-hover:text-white dark:group-hover:text-black">Expand your skills with interactive demo experiences.</p>
                </div>
            </a>
        </div></>);
}