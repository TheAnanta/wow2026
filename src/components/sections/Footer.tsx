        ...
        <div className="flex justify-between w-full lg:w-auto items-center mb-4 lg:mb-0">
          <a href="https://developers.google.com/" target="_blank" rel="noreferrer noopener" aria-label="Google Developers homepage">
            ...
            <svg width="220" height="24" viewBox="0 0 180 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M34.8 9.4c-1.28 0-2.32 1.04-2.32 2.32s1.04 2.32 2.32 2.32c0.88 0 1.48-0.44 1.84-0.88h0.24v0.72c0 1.52-0.8 2.32-2.12 2.32-1.08 0-1.72-0.76-2-1.28L32.4 16.4c0.6 1.44 2.04 2.36 3.76 2.36 2.04 0 3.76-1.2 3.76-3.8V9.6H38.5v0.88C38.08 10 37.48 9.4 36.6 9.4zM34.92 10.6c0.64 0 1.2 0.52 1.2 1.2s-0.56 1.2-1.2 1.2-1.2-0.52-1.2-1.2 0.56-1.2 1.2-1.2z" fill="#9AA0A6" />
