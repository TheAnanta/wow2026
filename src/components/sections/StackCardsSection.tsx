...
export function StackCardsSection() {
  ...
  const STACK_CARDS: StackCard[] = [{
    ...
    label: t('mobile'),
    ariaLabel: t('explore_mobile_content_opens_explore_page_with_mobile_content_filter'),
    ...
    imgWidth: 316,
    imgHeight: 170,
    description: t('develop_for_a_range_of_audiences_and_form_factors'),
    analyticsEvent: 'mobile'
  }, {
    href: '/explore/?q=web',
    label: t('web'),
    ariaLabel: t('explore_web_content_opens_explore_page_with_web_content_filter'),
    ...
    imgWidth: 316,
    imgHeight: 170,
    description: t('create_fast_secure_sites_and_apps_for_the_open_web'),
    analyticsEvent: 'web'
  }, {
    href: '/explore/?q=ai',
    label: t('ml_ai'),
    ariaLabel: t('explore_mlai_content_opens_explore_page_with_ai_content_filter'),
    ...
    imgWidth: 316,
    imgHeight: 170,
    description: t('access_cuttingedge_ai_models_and_open_source_tools_for_machine_learning'),
    analyticsEvent: 'ai'
  }, {
    href: '/explore/?q=cloud',
    label: t('cloud'),
    ariaLabel: t('explore_cloud_content_opens_explore_page_with_cloud_content_filter'),
    ...
    imgWidth: 316,
    imgHeight: 170,
    description: t('simplify_and_scale_endtoend_development'),
    analyticsEvent: 'cloud'
  }];
  return <div className="page-wrapper flex flex-col pt-0! pb-0!">
      <div className="flex flex-col mt-8 md:mt-10 mb-4 md:mb-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 ml:grid-cols-4 md:justify-around ml:justify-between gap-y-8 md:gap-3 mt-4 md:mt-10">
          {STACK_CARDS.map(card => <a key={card.label} href={card.href} aria-label={card.ariaLabel} className="relative rounded-[20px] md:border-2 dark:md:border-transparent md:border-transparent min-h-[135px] md:min-h-[297px] hover:border-grey! group dark:hover:border-grey-bg! group" data-analytics-event="content_card_select" data-analytics-event-data={`{"cardName": "${card.analyticsEvent}"}`}>
              <div style={{
